"""
Minorly tweaked from https://github.com/wxywb/history_rag/blob/master/custom/llms/proxy_model.py.
...
PROXY_API_KEY = "9e3d5d7d3ff2e74fc9c7e0684c3b6555.feSMhxTcgznEB07f"
PROXY_SERVER_URL = "https://open.bigmodel.cn/api/paas/v4/"
LLM_MODEL = "glm-4-air"


class ProxyModel(LLM):
    model_name: str = Field(default=LLM_MODEL, description="The Proxy_model to use.")
