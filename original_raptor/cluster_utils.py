...
def global_cluster_embeddings(
    ...
    logging.info(f"n_neighbors in global cluster embeddings:{n_neighbors}")
...
def local_cluster_embeddings(
    ...
    logging.info(f"n_neighbors in local cluster embeddings:{num_neighbors}")
    reduced_embeddings = umap.UMAP(
...
class RAPTOR_Clustering(ClusteringAlgorithm):
    def perform_clustering(
        ...
        print(
            f"after clustering, elapsed time:{elapsed_time} seconds, dim:{reduction_dimension}"
        )
